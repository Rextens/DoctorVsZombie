...
#include "GreenMedicineProjectile.h"

#include "PaperFlipbook.h"
#include "Pixel2DComponent.h"
#include "DoctorVsZombie/Character/DoctorCharacter.h"
#include "DoctorVsZombie/Character/Fight/DamageTypes/GreenMedicineDamageType.h"
#include "Kismet/GameplayStatics.h"
#include "Sound/SoundCue.h"

AGreenMedicineProjectile::AGreenMedicineProjectile()
{
	static ConstructorHelpers::FObjectFinder<UPaperFlipbook> ProjectileAnimation(TEXT("/Game/TopDownCPP/Animation/Flipbooks/Arsenal/GreenPotion_Flipbook"));
	...
	TypeOfDamage = UGreenMedicineDamageType::StaticClass();
}

void AGreenMedicineProjectile::Tick(float DeltaSeconds)
{
...
void AGreenMedicineProjectile::OnHit(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
