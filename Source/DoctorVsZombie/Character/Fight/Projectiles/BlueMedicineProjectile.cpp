...
#include "BlueMedicineProjectile.h"

#include "PaperFlipbook.h"
#include "Pixel2DComponent.h"
#include "DoctorVsZombie/Character/DoctorCharacter.h"
#include "Sound/SoundCue.h"
#include "DoctorVsZombie/Character/Fight/DamageTypes/BlueMedicineDamageType.h"
#include "Kismet/GameplayStatics.h"

ABlueMedicineProjectile::ABlueMedicineProjectile()
{
	static ConstructorHelpers::FObjectFinder<UPaperFlipbook> ProjectileAnimation(TEXT("/Game/TopDownCPP/Animation/Flipbooks/Arsenal/BluePotion_Flipbook"));
	...
	TypeOfDamage = UBlueMedicineDamageType::StaticClass();
}

void ABlueMedicineProjectile::Tick(float DeltaSeconds)
{
...
void ABlueMedicineProjectile::OnHit(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
